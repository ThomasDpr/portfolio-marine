      ...
      >
        <div
          className="
                    absolute right-[-5%]
                    top-[-10%] h-20 w-20
                    rounded-2xl bg-gradient-to-tl from-red-700 to-neutral-900 shadow-md"
        ></div>
        <div
          className="absolute bottom-[-10%]
                        ...
                        flex
                        h-20
                        w-20 items-center justify-center rounded-full bg-gradient-to-br from-red-700 to-neutral-900 shadow-md "
        ></div>
        <div className="flex flex-col items-center justify-center gap-4">
          ...
          <Link
            ...
            className={clsx(
              ...
              "icon-visible z-10 gap-4 hover:bg-red-700 hover:text-white transition-transform !duration-1000",
            )}
          >
