...
export const Header = () => {
    return (
        <div className="flex flex-col ">
            <main
                className="grid grid-cols-2 items-center bg-gradient-to-b
        from-transparent
        to-neutral-100 px-6
        pb-20 dark:from-transparent dark:to-neutral-900
        md:grid-cols-12 md:grid-rows-6 md:gap-6 md:gap-x-32 md:px-10 md:pb-10">
                <Description />
                <Avatar />
            </main>
            ...
            {/* <div className="relative">
                <div className="absolute-center">
                    <svg
                        className="circle-svg animate-spin-slow "
                        viewBox="0 0 500 500">
                        <defs>
                            <path
                        ...
                        <text className="circle-text" dy="70" textLength="1220">
                            <textPath xlinkHref="#textcircle_top">
                                Davinci • Photoshop • Illustrator • InDesign •
                                Premiere Pro •
                            </textPath>
                        </text>
                    </svg>
